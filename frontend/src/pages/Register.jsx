        ...
        <section style={{ 
            ...
            <div style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: '12px' }}>
                    ...
                    <h2 style={{ fontSize: '18px', fontWeight: 600, letterSpacing: '-0.03em', lineHeight: 1.2, marginBottom: '2px' }}>Create an account</h2>
                    <p style={{ fontSize: '11px', color: 'var(--text-muted)' }}>Get started with SnapPDF for free</p>
                </div>
                ...
                <form onSubmit={onSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    <div>
                        <label style={{ display: 'block', fontSize: '11px', fontWeight: 500, marginBottom: '2px', color: 'var(--text-muted)' }}>Username <span style={{ color: 'var(--accent)' }}>*</span></label>
                        <input
                            type="text"
                            name="username"
                            value={username}
                    ...
                    <div>
                        <label style={{ display: 'block', fontSize: '11px', fontWeight: 500, marginBottom: '2px', color: 'var(--text-muted)' }}>Email <span style={{ color: 'var(--accent)' }}>*</span></label>
                        <input
                            type="email"
                            name="email"
                            value={email}
                    ...
                    <div>
                        <label style={{ display: 'block', fontSize: '11px', fontWeight: 500, marginBottom: '2px', color: 'var(--text-muted)' }}>Password <span style={{ color: 'var(--accent)' }}>*</span></label>
                        <input
                            type="password"
                            name="password"
                            value={password}
                    ...
                    <div>
                        <label style={{ display: 'block', fontSize: '11px', fontWeight: 500, marginBottom: '2px', color: 'var(--text-muted)' }}>Profession (Optional)</label>
                        <input
                            type="text"
                            name="profession"
                            value={profession}
