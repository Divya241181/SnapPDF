                        ...
                        {filteredPdfs.map(pdf => (
                            <div key={pdf._id} className="border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden bg-white dark:bg-slate-900 shadow-sm hover:shadow-md transition-all duration-300">
                                ...
                                <div className="p-2 sm:p-3 border-t border-slate-100 dark:border-slate-800">
                                    ...
                                    <div className="flex items-center gap-1.5 sm:gap-2 border-t border-slate-100 dark:border-slate-800 pt-2 sm:pt-3">
                                        <a
                                            href={`${axios.defaults.baseURL}${pdf.fileUrl}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex-1 flex items-center justify-center gap-1.5 py-1.5 text-[10px] sm:text-xs font-medium text-slate-600 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-lg transition-colors"
                                            title="View"
                                        >
                                        ...
                                        <a
                                            href={`${axios.defaults.baseURL}${pdf.fileUrl}`}
                                            download
                                            className="flex-1 flex items-center justify-center gap-1.5 py-1.5 text-[10px] sm:text-xs font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors"
                                            title="Download"
                                        >
                                        ...
                                        <Link
                                            to={`/edit/${pdf._id}`}
                                            className="flex-1 flex items-center justify-center gap-1.5 py-1.5 text-[10px] sm:text-xs font-medium text-slate-600 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-lg transition-colors border border-transparent hover:border-blue-500/30"
                                            title="Edit"
                                        >
